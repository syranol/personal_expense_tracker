...
def main():
    ...
    try:
        ...
        # Seed expenses
        expenses = [
            Expense(user_id, coffee_category_id, merchant_id, 856, "2025-11-01", "Latte"),
            ...
            Expense(user_id, food_category_id, merchant_id_1, 24700, "2025-10-27", None),
            Expense(user_id, food_category_id, merchant_id_2, 10500, "2025-09-12", None),
            Expense(user_id, food_category_id, merchant_id_3, 7200, "2025-04-08", None),
            Expense(user_id, food_category_id, merchant_id_4, 5600, "2025-11-01", None),
            Expense(user_id, food_category_id, merchant_id_4, 6300, "2025-07-21", None)
        ]
        for e in expenses:
